document.addEventListener("DOMContentLoaded", function(event) {
    ...
    document.querySelector('.show-all-top-products').addEventListener('click', ()=>{
    ...
    document.querySelector('.show-all-recent-orders').addEventListener('click', ()=>{
...
//Way Back
document.querySelector('.to-offers-from-add-offer').addEventListener('click', ()=>{
...
//Way Back
document.querySelector('.to-products-from-add-product').addEventListener('click', ()=>{
    $('.latest-products-card').removeClass('hidden')
...
//Create Offer
    document.querySelector('.submit-create-offer').addEventListener('click', ()=>{
        ...
        let normal_customer_offer_description = $('.normal_customer_offer_description').val()
        let agent_customer_offer_description = $('.agent_customer_offer_description').val()
        let company_customer_offer_description = $('.company_customer_offer_description').val()
        let supermarket_customer_offer_description = $('.supermarket_customer_offer_description').val()
        let restuarant_customer_offer_description = $('.restuarant_customer_offer_description').val()
        let normal_customer_offer_description_ar = $('.normal_customer_offer_description_ar').val()
        let agent_customer_offer_description_ar = $('.agent_customer_offer_description_ar').val()
        let company_customer_offer_description_ar = $('.company_customer_offer_description_ar').val()
        let supermarket_customer_offer_description_ar = $('.supermarket_customer_offer_description_ar').val()
        let restuarant_customer_offer_description_ar = $('.restuarant_customer_offer_description_ar').val()
        let offer_normal_customer_price = parseInt($('.offer_normal_customer_price').val())
        let offer_agent_customer_price = parseInt($('.offer_agent_customer_price').val())
        let offer_company_customer_price = parseInt($('.offer_company_customer_price').val())
        let offer_supermarket_customer_price = parseInt($('.offer_supermarket_customer_price').val())
        let offer_restuarant_customer_price = parseInt($('.offer_restuarant_customer_price').val())
        ...
        offer_form.append('normal_customer_offer_description', `${normal_customer_offer_description}`)
        offer_form.append('agent_customer_offer_description', `${agent_customer_offer_description}`)
        offer_form.append('company_customer_offer_description', `${company_customer_offer_description}`)
        offer_form.append('supermarket_customer_offer_description', `${supermarket_customer_offer_description}`)
        offer_form.append('restuarant_customer_offer_description', `${restuarant_customer_offer_description}`)
        offer_form.append('normal_customer_offer_description_ar', `${normal_customer_offer_description_ar}`)
        offer_form.append('agent_customer_offer_description_ar', `${agent_customer_offer_description_ar}`)
        offer_form.append('company_customer_offer_description_ar', `${company_customer_offer_description_ar}`)
        offer_form.append('supermarket_customer_offer_description_ar', `${supermarket_customer_offer_description_ar}`)
        offer_form.append('restuarant_customer_offer_description_ar', `${restuarant_customer_offer_description_ar}`)
        offer_form.append('normal_customer_offer_price', offer_normal_customer_price)
        offer_form.append('agent_customer_offer_price', offer_agent_customer_price)
        offer_form.append('company_customer_offer_price', offer_company_customer_price)
        offer_form.append('supermarket_customer_offer_price', offer_supermarket_customer_price)
        offer_form.append('restuarant_customer_offer_price', offer_restuarant_customer_price)
        offer_form.append('meal_id', meal_id)
        offer_form.append('offer_image', offer_image)
        console.log(offer_form)
        fetch('/offer_managment/', {
            method: "POST",
            headers : {
            ...
            if(res.message == "Offer Created Successfully"){
                ...
                $('.offer_meal > option[selected="selected"]').removeAttr('selected');
...
//Create Meal
document.querySelector('.submit-create-meal').addEventListener('click', ()=>{
    ...
    fetch('/meal_managment/', {
        ...
        `)
            ...
            $('.meal_category > option[selected="selected"]').removeAttr('selected');
